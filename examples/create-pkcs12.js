...
try {
  ...
  console.log(certkit.util.encode64(newPkcs12Der));

  // create CA store (w/own certificate in this example)
  var caStore = certkit.pki.createCaStore([cert]);
...
function loadPkcs12(pkcs12Der, password, caStore) {
  var pkcs12Asn1 = certkit.asn1.fromDer(pkcs12Der);
  var pkcs12 = certkit.pkcs12.pkcs12FromAsn1(pkcs12Asn1, false, password);
