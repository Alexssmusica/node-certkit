...
const SHA512 = certkit.sha512;
describe('sha512', function() {
    it('should have correct digest length', (ctx) => {
      var md = SHA512.create();
      expect(md.digestLength).toBe(64);
    });

    it('should digest the empty string', (ctx) => {
      var md = SHA512.create();
      expect(md.digest().toHex()).toBe('cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce47d0d13c5d85f2b0ff8318d2877eec2f63b931bd47417a81a538327af927da3e');
    });

    it('should digest "abc"', (ctx) => {
      var md = SHA512.create();
      md.update('abc');
      expect(md.digest().toHex()).toBe('ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f');
    });
    ...
    it('should digest "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu"', (ctx) => {
      ...
      expect(md.digest().toHex()).toBe('8e959b75dae313da8cf4f72814fc143f8f7779c6eb9f7fa17299aeadb6889018501d289e4900f7e4331b99dec4b5433ac7d329eeb6dd26545e96e55b874be909');
    });

    it('should digest "The quick brown fox jumps over the lazy dog"', (ctx) => {
      var md = SHA512.create();
      md.update('The quick brown fox jumps over the lazy dog');
      expect(md.digest().toHex()).toBe('07e547d9586f6a73f73fbac0435ed76951218fb7d0c8d788a309d785436bbb642e93a252a954f23912547d1e8a3b5ed6e1bfd7097821233fa0538f3db854fee6');
    });

    it('should digest "c\'\u00e8"', (ctx) => {
      var md = SHA512.create();
      md.update('c\'\u00e8', 'utf8');
      expect(md.digest().toHex()).toBe('9afdc0390dd91e81c63f858d1c6fcd9f949f3fc89dbdaed9e4211505bad63d8e8787797e2e9ea651285eb6954e51c4f0299837c3108cb40f1420bca1d237355c');
    });
    ...
    it('should digest "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq"', (ctx) => {
      ...
      expect(md.digest().toHex()).toBe('204a8fc6dda82f0a0ced7beb8e08a41657c16ef468b228a8279be331a703c33596fd15c13b1b07f9aa1d3bea57789ca031ad85c7a71dd70354ec631238ca3445');
      expect(md.digest().toHex()).toBe('204a8fc6dda82f0a0ced7beb8e08a41657c16ef468b228a8279be331a703c33596fd15c13b1b07f9aa1d3bea57789ca031ad85c7a71dd70354ec631238ca3445');
    });
    ...
    it('should digest multiple long messages', (ctx) => {
      ...
      for(var loop = 0; loop < 3; ++loop) {
        ...
        expect(md.digest().toHex()).toBe('d046212bac4588e4bf5e33fcac26183e548f7efe8d36df45db885a31c4c23bbb3b9da10225405b4be3491c4d923937f8b5e165ecd4cadc8d0680cadb164c112f');
      }
    });
  });
  ...
  describe('sha384', function() {
    it('should have correct digest length', (ctx) => {
      ...
      expect(md.digestLength).toBe(48);
    });
  ...
  describe('sha512/256', function() {
    ...
    it('should digest the empty string', (ctx) => {
      var md = SHA256.create();
      expect(md.digest().toHex()).toBe('c672b8d1ef56ed28ab87c3622c5114069bdd3ad7b8f9737498d0c01ecef0967a');
    });

    it('should digest "The quick brown fox jumps over the lazy dog"', (ctx) => {
      var md = SHA256.create();
      md.update('The quick brown fox jumps over the lazy dog');
      expect(md.digest().toHex()).toBe('dd9d67b371519c339ed8dbd25af90e976a1eeefd4ad3d889005e532fc5bef04d');
    });
  });
  ...
  describe('sha512/224', function() {
    ...
    it('should digest the empty string', (ctx) => {
      var md = SHA224.create();
      expect(md.digest().toHex()).toBe('6ed0dd02806fa89e25de060c19d3ac86cabb87d6a0ddd05c333b84f4');
    });

    it('should digest "The quick brown fox jumps over the lazy dog"', (ctx) => {
      var md = SHA224.create();
      md.update('The quick brown fox jumps over the lazy dog');
      expect(md.digest().toHex()).toBe('944cd2847fb54558d4775db0485a50003111c8e5daa63fe722c6aa37');
    });
  });
