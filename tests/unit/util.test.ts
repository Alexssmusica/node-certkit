...
describe('util', function () {
  ...
  it('should base64 encode some bytes using util.binary.base64', (ctx) => {
    var s1 = new Uint8Array([
      0x30, 0x30, 0x30, 0x31, 0x30, 0x32, 0x30, 0x33, 0x30, 0x35, 0x30, 0x36, 0x30, 0x37, 0x30, 0x38, 0x30, 0x41, 0x30, 0x42, 0x30, 0x43,
      0x30, 0x44, 0x30, 0x46, 0x31, 0x30, 0x31, 0x31, 0x31, 0x32, 0x31, 0x34, 0x31, 0x35, 0x31, 0x36, 0x31, 0x37, 0x31, 0x39
    ]);
    var s2 = 'MDAwMTAyMDMwNTA2MDcwODBBMEIwQzBEMEYxMDExMTIxNDE1MTYxNzE5';
  ...
  it('should base64 encode some odd-length bytes using util.binary.base64', (ctx) => {
    var s1 = new Uint8Array([
      0x30, 0x30, 0x30, 0x31, 0x30, 0x32, 0x30, 0x33, 0x30, 0x35, 0x30, 0x36, 0x30, 0x37, 0x30, 0x38, 0x30, 0x41, 0x30, 0x42, 0x30, 0x43,
      0x30, 0x44, 0x30, 0x46, 0x31, 0x30, 0x31, 0x31, 0x31, 0x32, 0x31, 0x34, 0x31, 0x35, 0x31, 0x36, 0x31, 0x37, 0x31, 0x39, 0x31, 0x41,
      0x31, 0x42
    ]);
