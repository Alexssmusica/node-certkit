...
describe('des', function () {
  ...
  it('should des-ecb encrypt: foobar', (ctx) => {
    var key = UTIL.createBuffer(UTIL.hexToBytes('a1c06b381adf3651'));
  ...
  it('should check des-cbc short IV', (ctx) => {
    var key = UTIL.createBuffer(UTIL.hexToBytes('a1c06b381adf3651'));
    var iv = UTIL.createBuffer(UTIL.hexToBytes('818bcf76efc596'));
  ...
  it('should des-cbc encrypt: foobar', (ctx) => {
    var key = UTIL.createBuffer(UTIL.hexToBytes('a1c06b381adf3651'));
    var iv = UTIL.createBuffer(UTIL.hexToBytes('818bcf76efc59662'));
  ...
  it('should des-ctr decrypt: foobar', (ctx) => {
    var key = UTIL.createBuffer(UTIL.hexToBytes('beefdeadbeefdead'));
    var iv = UTIL.createBuffer(UTIL.hexToBytes('deadbeefdeadbeef'));
  ...
  it('should 3des-ecb encrypt: foobar', (ctx) => {
    var key = UTIL.createBuffer(UTIL.hexToBytes('a1c06b381adf36517e84575552777779da5e3d9f994b05b5'));
