...
export class BigInteger {
  ...
  isEven() { return ((this.t>0)?(this.data[0]&1):this.s) == 0;  }
  ...
  byteValue() { return (this.t==0)?this.s:(this.data[0]<<24)>>24;  }

  shortValue() { return (this.t==0)?this.s:(this.data[0]<<16)>>16;  }

  chunkSize(r: any) { return Math.floor(Math.LN2*this.DB/Math.log(r));  }
  ...
  equals(a: any) { return(this.compareTo(a)==0);  }
  min(a: any) { return(this.compareTo(a)<0)?this:a;  }
  max(a: any) { return(this.compareTo(a)>0)?this:a;  }
  ...
  and(a: any) { const r = nbi(); this.bitwiseTo(a,op_and,r); return r;  }

  or(a: any) { const r = nbi(); this.bitwiseTo(a,op_or,r); return r;  }

  xor(a: any) { const r = nbi(); this.bitwiseTo(a,op_xor,r); return r;  }

  andNot(a: any) { const r = nbi(); this.bitwiseTo(a,op_andnot,r); return r;  }
  ...
  setBit(n: any) { return this.changeBit(n,op_or);  }

  clearBit(n: any) { return this.changeBit(n,op_andnot);  }

  flipBit(n: any) { return this.changeBit(n,op_xor);  }
  ...
  add(a: any) { const r = nbi(); this.addTo(a,r); return r;  }

  subtract(a: any) { const r = nbi(); this.subTo(a,r); return r;  }

  multiply(a: any) { const r = nbi(); this.multiplyTo(a,r); return r;  }

  square() { const r = nbi(); this.squareTo(r); return r;  }

  divide(a: any) { const r = nbi(); this.divRemTo(a,r,null); return r;  }

  remainder(a: any) { const r = nbi(); this.divRemTo(a,null,r); return r;  }
  ...
  pow(e: any) { return this.exp(e,new NullExp());  }
